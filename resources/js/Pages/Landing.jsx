...
export default function Landing({
    ...
    return (
        <div className="min-h-screen  ">
            ...
            <section
                className="relative lg:min-h-[200px]"
                style={{
                ...
                <div className="container mx-auto px-6 md:px-10 lg:px-20 relative z-10">
                    <div className="flex flex-row gap-3 ">
                        <div className="w-full pt-10 space-y-3">
                            <p className="text-white text-base font-light">Welcome to STS</p>
                            <h1 className="font-bebas-neue text-white text-xl md:text-3xl lg:text-5xl leading-tight">
                                {activeBanner?.name ?? 'Banner Coming Soon'}
                            </h1>
                            <div className=" md:mt-10 mt-5 py-10 ">
                                <a
                                    href={ctaHref}
                                    className="md:mb-10 lg:mt-20 sm:mb-20 inline-flex items-center gap-2 rounded-lg bg-[#0079C2] px-3 py-1.5 md:px-5 md:py-2 font-semibold text-[#fff] transition hover:-translate-y-0.5 text-xs md:text-sm"
                                >
                                    Shop Now
                                    <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" className="md:w-5 md:h-5 w-4 h-4"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m18 8l4 4l-4 4M2 12h20"></path></svg>
                                </a>
                            </div>
                        </div>
...
/>
                ...
                {banners.length > 1 && (
                    <div className="absolute z-20 bottom-2 lg:bottom-5 flex w-full pointer-events-none">
                        <div className="flex w-full justify-between">
                            <button
                                type="button"
                                onClick={goPrevious}
                                className="pointer-events-auto inline-flex items-end gap-2 border-none bg-white px-2 py-1 sm:px-3 sm:py-1.5 md:px-5 md:py-2 font-semibold text-[#0079C2] transition hover:bg-[#0079C2] hover:text-white text-xs sm:text-sm md:text-lg"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" className="sm:w-5 sm:h-5 w-4 h-4 md:w-6 md:h-6"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m6 8l-4 4l4 4m-4-4h20" /></svg>
                            </button>
                            <button
                                type="button"
                                onClick={goNext}
                                className="pointer-events-auto inline-flex items-start gap-2 border-none bg-white px-2 py-1 sm:px-3 sm:py-1.5 md:px-5 md:py-2 font-semibold text-[#0079C2] transition hover:bg-[#0079C2] hover:text-white text-xs sm:text-sm md:text-lg"
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" className="sm:w-5 sm:h-5 w-4 h-4 md:w-6 md:h-6"><path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m18 8l4 4l-4 4M2 12h20"></path></svg>
                            </button>
                        </div>
                    </div>
                )}
                    ...
                    >
                        {banners.map((banner, index) => (
                            <button
                                ...
                                className={`h-2 w-2 md:h-3 md:w-3 rounded-full border border-[#0079C2]/70 transition ${currentBannerIndex === index
                                    ? 'bg-black'
                    ...
                    <div className="flex flex-col gap-6 ">
                        ...
                        <div className="flex gap-2">
                            <a
                                ...
                                className="bg-white text-black rounded-full p-2 transition-colors duration-200 hover:bg-black hover:text-white"
                            >
                    ...
                    <form className="space-y-6" id='contact-submission' onSubmit={handleSubmit}>
                        <div className="flex flex-col md:flex-row gap-6">
                            <div className="flex-1">
                                ...
                                <input
                                    ...
                                    className="w-full border-0 border-b-2 border-gray-300 bg-transparent focus:ring-0 focus:border-[#000] outline-none py-2"
                                    autoComplete="off"
                                    required
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleInputChange}
                                rows={4}
                                className="w-full border-0 border-b-2 border-gray-300 bg-transparent focus:ring-0 focus:border-[#000] outline-none py-2 resize-none"
                                required
                            ></textarea>
                        </div>
