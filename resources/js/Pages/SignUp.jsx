...
import { Head, useForm } from '@inertiajs/react'; // Ensure useForm is imported
                    ...
                    <div className="flex flex-col md:flex-row md:space-x-8 space-y-8 md:space-y-0 mx-auto mt-8 text-left">
                        ...
                        <form onSubmit={submit} className="flex-1">
                            ...
                            <div className="mt-10 p-10 space-y-6 md:max-h-none md:h-auto overflow-auto bg-white">
                                ...
                                <div className="flex justify-start mt-8">
                                    <button disabled={processing} className="bg-[#0079C2] text-white px-20 py-2 rounded font-medium hover:bg-[#005b8c] flex items-center justify-center gap-2">
