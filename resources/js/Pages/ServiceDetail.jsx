...
export default function ServiceDetail() {
    ...
    return (
        <div className="bg-[#302F2F]">
            ...
            <main className="flex-1 container mx-auto px-10 md:px-10 text-center py-20">
                <section className=' mb-30'>

               <h1 className='font-monserat font-bold text-3xl md:text-5xl text-white mb-2'>We are not a call centre.
