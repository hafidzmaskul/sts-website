    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 ">
                {/* Responsive flex-col on mobile/tablet, flex-row on md+ */}
                <section className="flex flex-col md:flex-row w-full rounded-lg overflow-hidden mb-8 md:mb-16 py-10 md:py-20">
                    <div
                        className="w-full md:w-2/5 p-4 md:p-8 flex flex-col justify-center"
                        style={{ backgroundColor: '#0079C2' }}
                    >
                        <h2 className="text-white font-bold text-xl md:text-2xl mb-4">Commissioning services include:</h2>
                        <ul className="list-disc list-inside text-white space-y-2 ml-3 text-base font-medium flex flex-col">
                    ...
                    <div className="w-full md:w-3/5 bg-white flex items-stretch min-h-[200px]">
                        <img
                    ...
                    <div className="container mx-auto px-4">
                        <div className="flex flex-col md:flex-row justify-between gap-4 md:gap-2 mb-8">
                            ...
                            <div className="flex-1 flex justify-end">
                                <ul className="list-disc list-inside text-white text-sm md:text-base font-medium space-y-1 text-left pl-5 max-w-full">
                                    <li>
                            ...
                            >
                                {whyChooseItems.map((item, index) => (
                                    <SwiperSlide key={index}>
                                        {({ isActive }) => (
                                            <div className={`relative pb-6 md:pb-20 flex flex-col items-center transition-all duration-300 ${isActive ? 'z-10' : 'opacity-80'}`}>
                                                ...
                                                <div className="w-full bg-white py-2 md:py-4 flex items-center justify-center">
                ...
                <section className='bg-[#F0F2F3] py-12 md:py-20'>
                    <h1 className='font-inter font-bold text-2xl md:text-3xl text-center mt-8 md:mt-10 mb-6 md:mb-15 text-[#002856]'>Benefits of pre-build and configuration</h1>
                    <div className="container mx-auto px-4">
                ...
                {/* Resource Hub Section - Mobile first optimization */}
                <section className="container mx-auto px-4 flex flex-col md:flex-row gap-6 my-8 md:my-10">
                    {/* Section Left */}
                    <div className="w-full md:w-5/7 flex flex-col justify-center h-auto">
                        <div
                            className="p-6 md:p-8 h-full text-white"
                            style={{
                                background: "linear-gradient(302.66deg, #0079C2 0%, #0069A9 100%)"
                            }}
                        >
                            <h2 className="text-xl md:text-2xl font-bold font-inter mb-3 md:mb-4">Resource Hub</h2>
                    ...
                    {/* Section Right */}
                    <div className="w-full md:w-2/7 flex items-center justify-center">
                        <img src="/assets/resource-cofig.png" className='w-full h-40 md:h-full object-contain' alt="Resource config" />
                    </div>
                </section>

                {/* How It Works + Quote Section - Responsive Stack */}
                <section
                    id='form-quote'
                    className="container mx-auto px-4 md:px-20 flex flex-col md:flex-row gap-8 md:gap-0 my-8 md:my-10"
                >
                    <div className="w-full md:w-1/2 flex flex-col h-auto">
                        <div className="flex flex-col items-center text-center px-0 md:px-4">
                            <h2 className="text-xl md:text-3xl font-bold mt-6 md:mt-20 mb-6 md:mb-10">How it works</h2>
                    ...
                    <div className="w-full md:w-1/2 bg-[#F0F2F3] flex items-center justify-center p-4 md:p-0">
                        <QuoteForm
                            title="Get Quote"
