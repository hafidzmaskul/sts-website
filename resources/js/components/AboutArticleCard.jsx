...
export default function AboutArticleCard({
  ...
  return (
    <div className="flex flex-col w-full max-w-4xl overflow-hidden rounded-xl bg-white shadow-sm h-[700px] md:h-[920px] lg:h-[900px]">
      ...
      />
      {/* Bawah: Text */}
      <div className="flex flex-col space-y-4 px-6 py-6 md:px-10 md:py-8 bg-[#0079C2] flex-1 justify-between" style={{ minHeight: '20%' }}>
        <div>
        ...
        <div className=" mt-auto">
          <a
            href={buttonHref}
            className="  items-center justify-center rounded-lg bg-white px-6 py-3 text-sm font-semibold text-[#0079C2] transition hover:bg-gray-100"
          >
            {buttonLabel}
          </a>
        </div>
