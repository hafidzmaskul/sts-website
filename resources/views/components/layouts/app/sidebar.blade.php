...
<body class="min-h-screen bg-[#F0F2F3]">
    ...
    <flux:sidebar sticky stashable class="custom-sidebar-bg">
        ...
        <a href="{{ route('dashboard') }}" class="me-5 flex text-white items-center space-x-2 rtl:space-x-reverse" wire:navigate>
            <x-app-logo />
        </a>
        ...
        <flux:navlist variant="outline">
            ...
            <flux:navlist.group :heading="__('Platform')" class="grid">
                <flux:navlist.item
                    ...
                    wire:navigate
                    :class="request()->routeIs('dashboard') ? 'custom-navitem-active' : 'custom-navitem'"
        ...
        <flux:dropdown class="hidden lg:block" position="bottom" align="start">
            <flux:profile  class="custom-navitem" :initials="auth()->user()->initials()"
