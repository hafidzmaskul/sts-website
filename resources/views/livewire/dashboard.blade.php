            ...
            <div class="space-y-4">
                @forelse($recent_news as $article)
                    <div class="flex items-center justify-between border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                        ...
                        <span class="px-2 py-1 text-xs rounded-full border {{ $article->status === 'published' ? 'border-green-600 text-green-600' : 'border-gray-400 text-gray-500' }}" style="background:transparent;">
