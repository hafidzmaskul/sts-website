        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div class="w-full max-w-lg rounded-2xl bg-white p-6">
                ...
                <form wire:submit.prevent="save" class="space-y-5">
                    ...
                    {{-- Password fields removed as credentials are auto-generated and emailed --}}
                    ...
                    <div class="flex items-center justify-end gap-2 pt-2">
                        ...
                        <button type="submit" wire:loading.attr="disabled" wire:target="save"
                            class="w-full md:w-auto bg-[#0079C2] text-white px-4 py-2 rounded-lg hover:cursor-pointer transition flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed">
