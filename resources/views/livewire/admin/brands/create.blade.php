<div class="p-6 space-y-6 w-full">
    <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-black">Create Brand</h1>
    </div>
    ...
    <div class="rounded-xl shadow p-6 border border-gray-200 bg-white">
        <form wire:submit="save" class="space-y-6">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <!-- Pricing Formula -->
                <div class="col-span-2">
                    <label for="pricing_formula_id" class="block text-sm font-medium mb-1 text-black">Pricing
                        Formula</label>
                ...
                <!-- Sort Order -->
                <div class="col-span-1">
                    <label for="sort_order" class="block text-sm font-medium mb-1 text-black">Sort
                        Order</label>
