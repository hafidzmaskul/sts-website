                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm divide-y divide-gray-200">
                        <thead class="bg-gray-50 text-left">
                            <tr>
                                <th class="px-6 py-3 font-medium uppercase tracking-wider text-xs text-gray-500">Product
                                </th>
                                <th class="px-6 py-3 font-medium uppercase tracking-wider text-xs text-gray-500">Price
                                </th>
                                <th class="px-6 py-3 font-medium uppercase tracking-wider text-xs text-gray-500">Qty
                                </th>
                                <th
                                    class="px-6 py-3 font-medium uppercase tracking-wider text-xs text-gray-500 text-right">
                                    Total</th>
                            </tr>
                        </thead>
                            ...
                            @foreach($transaction->items as $item)
                                <tr>
                                    <td class="px-6 py-4">
                                        ...
                                        @if($item->product)
                                            <div class="text-xs text-gray-500">SKU: {{ $item->product->slug }}</div>
                                        @endif
                                    </td>
                        ...
                        <tfoot class="bg-gray-50">
                            ...
                            <tr>
                                <td colspan="3" class="px-6 py-2 text-right text-gray-500">Tax</td>
                                <td class="px-6 py-2 text-right font-medium">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-4 space-y-4">
                    <div>
                        ...
                        <p class="text-gray-900">{{ $transaction->customer->user->name ?? 'Guest' }}</p>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-4 space-y-4">
                    ...
                    <div>
                        <p class="text-xs font-medium text-gray-400 uppercase">Payment Method</p>
                        <p class="text-gray-900">{{ $transaction->payment_method ?? 'Not Set' }}</p>
                    </div>
                    <div>
                        <p class="text-xs font-medium text-gray-400 uppercase">Order Date</p>
