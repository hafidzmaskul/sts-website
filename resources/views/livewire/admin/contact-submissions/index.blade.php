        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
            ...
            <div class="md:col-span-2 flex justify-end">
                <button wire:click="resetFilters"
                    class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-black bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Reset Filters
                </button>
            </div>
        </div>
                    ...
                    @forelse($submissions as $index => $submission)
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out" wire:key="submission-{{ $submission->id }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-2">
                                <button wire:click="viewDetails({{ $submission->id }})" class="text-indigo-600 hover:text-indigo-900">
                                    Detail
                                </button>
