            ...
            <form wire:submit.prevent="save" class="space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" wire:model="level" placeholder="e.g. Junior, Senior" class="w-full rounded-lg border px-3 py-2 dark:bg-zinc-800 dark:text-white dark:border-zinc-700">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1 dark:text-zinc-100">Employment Type</label>
                        <input type="text" wire:model="employment_type" placeholder="e.g. Full Time, Contract" class="w-full rounded-lg border px-3 py-2 dark:bg-zinc-800 dark:text-white dark:border-zinc-700">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1 dark:text-zinc-100">Department</label>
                        <input type="text" wire:model="department" placeholder="e.g. Engineering" class="w-full rounded-lg border px-3 py-2 dark:bg-zinc-800 dark:text-white dark:border-zinc-700">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1 dark:text-zinc-100">Location</label>
                        <input type="text" wire:model="location" placeholder="e.g. Remote, London" class="w-full rounded-lg border px-3 py-2 dark:bg-zinc-800 dark:text-white dark:border-zinc-700">
                    </div>
                </div>
