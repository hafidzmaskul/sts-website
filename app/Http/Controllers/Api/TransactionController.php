...
class TransactionController extends Controller
{
    public function store(Request $request, SquareInvoiceService $square)
    {
        ...
        try {
            ...
            $this->sendNotifications($transaction, $product, $invoiceUrl);
    ...
    private function sendNotifications($transaction, $product, $invoiceUrl)
    {
        ...
        $emailBody = implode("\n", [
            ...
            "VAT (20%)    : £" . number_format($transaction->vat_amount, 2),
